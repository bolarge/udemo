...
public class RabbitMQConfig {
    ...
    Queue queue() {
        ...
        // Only private queues that the creator can use, automatically deleted after disconnection
        ...
        // Whether to automatically delete the queue when all consumer clients are disconnected
